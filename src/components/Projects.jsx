            ...
            <div className="p-4 sm:p-5 flex flex-col">
              ...
              <div className="flex flex-col justify-between mt-3">
                ...
                <div className="flex justify-evenly lg:justify-around gap-2 ml-2 max-w-[158px] self-center">
                  ...
                  <a
                    href="https://ha-menuiserie.isoluti.com/"
                    target="blank"
                    className="group inline-flex items-center text-sm font-medium "
                  >
                    <div className="border-2 border-black border-solid text-white bg-black rounded-full py-2 px-4 hover:bg-white hover:text-black">
        ...
        <Tilt className="overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md w-full md:w-[32%]">
          <article>
            ...
            <div className="p-4 sm:p-5 flex flex-col">
              ...
              <p className="mt-2 line-clamp-3 text-sm/relaxed text-gray-500">
              Bienvenue sur le site de notre agence web, où nous donnons vie à votre présence en ligne de manière professionnelle. Explorez nos réalisations et contactez-nous pour discuter de la façon dont nous pouvons concrétiser vos projets sur mesure. Nous sommes passionnés par la création de solutions web exceptionnelles qui répondent à vos besoins uniques. Découvrez comment nous pouvons transformer votre présence en ligne en une expérience mémorable.
              </p>
              <div className="flex flex-col justify-between mt-3">
                <div className="flex justify-center my-5 lg:justify-start">
                  <DiWordpress size={40} />
